...
const Media = () => {
  return (
    <section className="flex flex-col items-center py-16 gap-12">
      ...
      <h1 className="px-4 bg-clip-text bg-gradient-to-r text-transparent from-green-400 to-blue-500 hover:from-green-500 hover:to-blue-600 active:from-green-600 active:to-blue-600 whitespace-nowrap overflow-hidden animate-typing">
