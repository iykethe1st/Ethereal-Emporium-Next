...
const Footer = () => {
  return (
    <section className="grid grid-cols-1 bg-black bg-opacity-50 items-end lg:justify-between justify-items-center lg:flex py-16 px-4 md:px-24 gap-8">
      <div className="flex flex-col gap-4 max-w-[22rem]">
        <Image src="/Group-20.png" height="50" width="50" alt="thefund" />
        <h1>THEFUND</h1>
        <span>
          TheFund is the world's first non-fungible token (NFT) marketplace for
